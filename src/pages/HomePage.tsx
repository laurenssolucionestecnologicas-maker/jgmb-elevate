        ...
        <div className="relative container-site py-20 md:py-28">
          <div className="max-w-2xl">
            <motion.h1
              ...
              className="font-sans font-bold text-4xl md:text-5xl lg:text-6xl tracking-tight text-primary-foreground mb-6"
            >
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-primary-foreground/80 leading-relaxed mb-8 font-body"
            >
